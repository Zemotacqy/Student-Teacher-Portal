...
public class Edit_student{
	...
	JButton edit,update;
	Edit_student(){
		f = new JFrame("Edit Student Information");
				...
				if(t1.getText().equals("") || t2.getText().equals("") || t3.getText().equals("") || t4.getText().equals("") || t5.getText().equals("")){
					...
					if(x==0){
						...
						try{
							...
							st.executeUpdate("update student set student_name='"+val1+"' , age='"+val2+"' , course='"+val3+"' , college='"+val4+"' , Contact='"+val5+"' WHERE student_id='"+val6+"'");
	...
	public static void main(String args[]){
		/*Edit_student d = new Edit_student();
		d.display();*/
	}
}